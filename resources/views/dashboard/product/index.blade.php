    ...
    <table class="table table-striped table-sm">
      ...
      <tbody>
          ...
          <tr>
            ...
            <td>
                <a href="/dashboard/product/{{ $product->id }}" class="badge bg-primary"><i class="bi bi-eye"></i></a>
                <a href="/dashboard/product/{{ $product->id }}/edit" class="badge bg-warning"><i class="bi bi-pencil"></i></a>
