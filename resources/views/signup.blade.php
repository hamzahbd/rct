            ...
            <div class="card-body p-5 text-center">
              ...
              <div class="mb-md-5 mt-md-4 pb-5">
                ...
                @endif
                  ...
                  <h2 class="fw-bold mb-2 text-uppercase mb-5">Daftar</h2>
                  
                  <div class="form-outline form-light mb-4">
                    <input type="text" name="name" id="name" class="form-control form-control-lg @error('name') is-invalid @enderror" placeholder="Nama" value="{{ old('name') }}"/>
                    @error('name')
                  ...
                  <button class="btn btn-primary btn-lg px-5 mt-4" type="submit">Daftar</button>
                </form>
              ...
              <div>
                <p class="mb-0">Sudah punya akun? <a href="/login" class="text-dark-50 fw-bold text-decoration-none"> Masuk</a>
                </p>
              </div>
